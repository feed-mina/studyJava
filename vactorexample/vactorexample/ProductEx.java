...
public class ProductEx {
    ...
    static int numberOfProduct = 0; // 인덱스 역할
    static Scanner sin = new Scanner(System.in);
    static Product02[] p = new Product02[10];
    ...
    public static void main(String[] args){
        ...
        while(choice != 3){
            int type = 0;
            System.out.println("상품조회 프로그램입니다");
            System.out.println("상품추가(1), 상품조회(2), 끝내기(3)>>");
            choice = sin.nextInt();
            
            // 분기가 정해져있다면 switch를 사용
            switch(choice) {
                case 1:
