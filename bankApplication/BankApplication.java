...
public class BankApplication {
	...
	//배열 100개 정적멤버로 되었있고, 배열이므로 한계가 있다.(메모리 낭비, 정적이다)
	...
	public static void createAccount() {
		...
		//next() : 한 단어를 입력받을 때 용이한 메서드(공백을 발견하면 그 앞까지만 String리턴)
...
//						           accountArray[i].getBalace());		
	...
	public static void deposit() {
		...
		System.out.println("결과 : 예금이 성공했습니다. 현재 잔액 : " + account.getBalace());		
	}
	...
	public static void withdraw() {
		...
		account.setBalace(account.getBalace() - money);
		System.out.println("결과 : 출금금이 성공했습니다. 현재 잔액 : " + account.getBalace());		
	}
